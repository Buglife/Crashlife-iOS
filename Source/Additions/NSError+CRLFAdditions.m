...
static NSString * const kErrorDomain = @"com.buglife.crashlife.NetworkManager.ErrorDomain";
...
+ (NSError *)crlf_errorWithHTTPURLResponse:(NSHTTPURLResponse *)httpResponse
{
    ...
    NSString *description = [NSString stringWithFormat:@"Crashlife API returned status code %ld.", (long)statusCode];
